...
* related 0..* Reference(DataQualityRuleDefinition) "Releated rules."
...
* configuration 1..1 BackboneElement "Configuration of the rule (Level, context, category, sub-category)"
...
* action 0..* BackboneElement "Actions taken based on potential rule outcome"
  ...
  * related 0..* BackboneElement "Related Actions"
